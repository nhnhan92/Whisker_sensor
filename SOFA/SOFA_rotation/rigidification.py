...
def createScene(rootNode):
        ...
        setData(o.RigidParts.RigidifiedParticules.dofs, showObject=1, showObjectScale=0.1,
                drawMode=1, showColor=[1., 1., 0., 1.])
        setData(o.DeformableParts.dofs, showObject=1, showObjectScale=0.1, drawMode=2)
